...
class FastRCNNOutputLayers(nn.Module):
    ...
    def __init__(
        ...
        Args:
            input_shape (dict): shape of the input feature to this module
        ...
        if isinstance(input_shape, int):  # some backward compatibility
            input_shape = dict(channels=input_shape)
        self.num_classes = num_classes
        input_size = input_shape['channels'] * (input_shape.get('width', 1)) * (input_shape.get('height', 1))
